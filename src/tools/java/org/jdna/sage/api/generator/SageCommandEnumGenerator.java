...
public class SageCommandEnumGenerator {
	...
	public Vector getCommandNames() {
		// no longer need to call into sagetv for this, we can use the contstant
		// Vector v = (Vector) SageAPI.call("GetSageCommandNames", null);
		java.util.Vector rv = new java.util.Vector(java.util.Arrays.asList(sage.UserEvent.PRETTY_UENAMES));
		rv.remove(0); // ?
		rv.remove(0); // ?

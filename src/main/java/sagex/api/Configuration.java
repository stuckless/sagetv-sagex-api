...
MsecDelay- the minimum delay in milliseconds between finishing one channel change sequence and starting another when using the specified 'Remote Control'
 */
public static int SetSequenceDelayForInfraredTuningPlugin (UIContext _uicontext,java.lang.String PluginName, int PluginPortNumber, java.lang.String RemoteName, int MsecDelay) {
  Object o = sagex.SageAPI.call(_uicontext, "SetSequenceDelayForInfraredTuningPlugin", new Object[] {PluginName,PluginPortNumber,RemoteName,MsecDelay});
  if (o!=null) return (Integer) o;
  return 0;
}

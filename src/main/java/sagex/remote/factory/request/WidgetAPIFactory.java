...
public class WidgetAPIFactory {
   ...
   if (command.equals("IsSTVModified")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"IsSTVModified",parameters,null);
   }
   if (command.equals("GetAllWidgets")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetAllWidgets",parameters,null);
   }
   ...
   if (command.equals("GetCurrentSTVFile")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetCurrentSTVFile",parameters,null);
   }
   ...
   if (command.equals("GetCurrentMenuWidget")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetCurrentMenuWidget",parameters,null);
   }
   if (command.equals("GetWidgetMenuHistory")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetWidgetMenuHistory",parameters,null);
   }
   if (command.equals("GetWidgetMenuBackHistory")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetWidgetMenuBackHistory",parameters,null);
   }

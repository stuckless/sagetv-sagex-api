...
public class ConfigurationFactory {
   ...
   if (command.equals("IsAdvancedDeinterlacingSupported")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"IsAdvancedDeinterlacingSupported",parameters,null);
   }
   if (command.equals("IsAdvancedDeinterlacingEnabled")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"IsAdvancedDeinterlacingEnabled",parameters,null);
   }

...
public class TranscodeAPIFactory {
   ...
   if (command.equals("GetTranscodeFormats")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetTranscodeFormats",parameters,null);
   }
   ...
   if (command.equals("ClearTranscodedJobs")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"ClearTranscodedJobs",parameters,null);
   }
   if (command.equals("GetTranscodeJobs")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetTranscodeJobs",parameters,null);
   }

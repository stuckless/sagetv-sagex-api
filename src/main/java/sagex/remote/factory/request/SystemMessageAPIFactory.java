...
public class SystemMessageAPIFactory {
   ...
   if (command.equals("GetSystemAlertLevel")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetSystemAlertLevel",parameters,null);
   }
   if (command.equals("GetSystemMessages")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetSystemMessages",parameters,null);
   }
   if (command.equals("ResetSystemAlertLevel")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"ResetSystemAlertLevel",parameters,null);
   }
   if (command.equals("DeleteAllSystemMessages")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"DeleteAllSystemMessages",parameters,null);
   }

...
public class UtilityFactory {
   ...
   if (command.equals("Time")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"Time",parameters,null);
   }
   if (command.equals("PrintCurrentTime")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"PrintCurrentTime",parameters,null);
   }
   ...
   if (command.equals("GetFileSystemRoots")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetFileSystemRoots",parameters,null);
   }
   if (command.equals("GetLocalFileSystemRoots")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetLocalFileSystemRoots",parameters,null);
   }
   ...
   if (command.equals("GetWorkingDirectory")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetWorkingDirectory",parameters,null);
   }
   if (command.equals("HasLocalFilesystem")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"HasLocalFilesystem",parameters,null);
   }
   ...
   if (command.equals("GetLocalIPAddress")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetLocalIPAddress",parameters,null);
   }
   ...
   if (command.equals("ClearMenuCache")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"ClearMenuCache",parameters,null);
   }
   ...
   if (command.equals("AreCoreAnimationsSupported")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"AreCoreAnimationsSupported",parameters,null);
   }

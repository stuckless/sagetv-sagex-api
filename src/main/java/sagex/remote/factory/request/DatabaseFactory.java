...
public class DatabaseFactory {
   ...
   if (command.equals("GetAllTitles")) {
      if (parameters!=null && parameters.length == 0) {
         return sagex.remote.xmlrpc.RequestHelper.createRequest(context, "GetAllTitles", parameters, null);
      }
      if (parameters!=null && parameters.length == 1) {
   ...
   if (command.equals("GetAllPeople")) {
      if (parameters!=null && parameters.length == 0) {
         return sagex.remote.xmlrpc.RequestHelper.createRequest(context, "GetAllPeople", parameters, null);
      }
      if (parameters!=null && parameters.length == 1) {
   ...
   if (command.equals("GetAllCategories")) {
      if (parameters!=null && parameters.length == 0) {
         return sagex.remote.xmlrpc.RequestHelper.createRequest(context, "GetAllCategories", parameters, null);
      }
      if (parameters!=null && parameters.length == 1) {
   ...
   if (command.equals("GetAllGroupingCategories")) {
      if (parameters!=null && parameters.length == 0) {
         return sagex.remote.xmlrpc.RequestHelper.createRequest(context, "GetAllGroupingCategories", parameters, null);
      }
      if (parameters!=null && parameters.length == 1) {

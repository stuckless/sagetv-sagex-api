...
public class PluginAPIFactory {
   ...
   if (command.equals("GetSageTVPluginRegistry")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetSageTVPluginRegistry",parameters,null);
   }
   if (command.equals("GetAllAvailablePlugins")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetAllAvailablePlugins",parameters,null);
   }
   if (command.equals("GetInstalledPlugins")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetInstalledPlugins",parameters,null);
   }
   ...
   if (command.equals("RefreshAvailablePlugins")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"RefreshAvailablePlugins",parameters,null);
   }
   ...
   if (command.equals("GetPluginProgress")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetPluginProgress",parameters,null);
   }
   if (command.equals("GetClientPluginProgress")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetClientPluginProgress",parameters,null);
   }
   if (command.equals("AreClientPluginsSupported")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"AreClientPluginsSupported",parameters,null);
   }

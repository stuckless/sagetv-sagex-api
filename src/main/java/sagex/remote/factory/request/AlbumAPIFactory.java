...
public class AlbumAPIFactory {
   ...
   if (command.equals("GetAllMusicArtists")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetAllMusicArtists",parameters,null);
   }
   if (command.equals("GetAllMusicGenres")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetAllMusicGenres",parameters,null);
   }
   if (command.equals("GetAlbums")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetAlbums",parameters,null);
   }

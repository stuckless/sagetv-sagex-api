...
public class SecurityFactory {
   ...
   if (command.equals("GetActiveSecurityProfile")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetActiveSecurityProfile",parameters,null);
   }
   if (command.equals("GetDefaultSecurityProfile")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetDefaultSecurityProfile",parameters,null);
   }
   ...
   if (command.equals("GetSecurityProfiles")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetSecurityProfiles",parameters,null);
   }
   ...
   if (command.equals("GetPredefinedPermissions")) {
      return sagex.remote.xmlrpc.RequestHelper.createRequest(context,"GetPredefinedPermissions",parameters,null);
   }

...
Parameters:
ExternalIDs- Array of external ID's to look up
Returns:
true for the corresponding index of each external ID that can be tracked, otherwise false on the same index
Since:
9.0
 */
public static boolean[] IsSDEPGInProgressSport (java.lang.String[] ExternalIDs) {
  return (boolean[]) sagex.SageAPI.call("IsSDEPGInProgressSport", new Object[] {ExternalIDs});
}
...
9.0
 */
public static boolean[] IsSDEPGInProgressSport (UIContext _uicontext,java.lang.String[] ExternalIDs) {
  return (boolean[]) sagex.SageAPI.call(_uicontext, "IsSDEPGInProgressSport", new Object[] {ExternalIDs});
}
...
9.0
 */
public static int[] GetSDEPGInProgressSportStatus (java.lang.String[] ExternalIDs) {
  return (int[]) sagex.SageAPI.call("GetSDEPGInProgressSportStatus", new Object[] {ExternalIDs});
}
...
9.0
 */
public static int[] GetSDEPGInProgressSportStatus (UIContext _uicontext,java.lang.String[] ExternalIDs) {
  return (int[]) sagex.SageAPI.call(_uicontext, "GetSDEPGInProgressSportStatus", new Object[] {ExternalIDs});
}
